...
export const Appbar = ({isUser}:{isUser:boolean})=>{
    return(
        <div>
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                ...
                <div className="flex-shrink-0 text-white font-bold text-xl py-2">
                    Multi-Event-Tix
                </div>
                <div className="hidden sm:ml-6 sm:block">
                    <div className="flex space-x-4">
                    <a
                        href={`/${isUser ? `user` : `admin`}/dashboard`}
                    ...
                    <a
                        href={`/${isUser ? `user` : `admin`}/createEvent`}
                        className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white"
                    >
                        Create Events
                    </a>
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div>
                        ...
                        <img className="size-9 rounded-full" src="https://res.cloudinary.com/dbbrijt9o/image/upload/v1744817022/cover-photos/twbramxi1kmt70hcwhnv.png" alt=""/>
                        </button>
                    </div>
